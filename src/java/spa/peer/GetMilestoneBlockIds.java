    ...
    JSONStreamAware processRequest(JSONObject request, Peer peer) {
        ...
        try {
            ...
            if (lastBlockIdString != null) {
                ...
                long myLastBlockId = Spa.getBlockchain().getLastBlock().getId();
                if (myLastBlockId == lastBlockId || Spa.getBlockchain().hasBlock(lastBlockId)) {
            ...
            if (lastMilestoneBlockIdString != null) {
                Block lastMilestoneBlock = Spa.getBlockchain().getBlock(Convert.parseUnsignedLong(lastMilestoneBlockIdString));
            ...
            blockId = Spa.getBlockchain().getBlockIdAtHeight(height);
