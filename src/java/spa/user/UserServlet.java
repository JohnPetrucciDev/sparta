...
import static spa.user.JSONResponses.DENY_ACCESS;
import static spa.user.JSONResponses.INCORRECT_REQUEST;
import static spa.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws SpaException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Spa.getBooleanProperty("spa.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException| SpaException e) {
