...
import spa.Spa;
import spa.http.APIServlet;
import spa.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        Spa.getStringListProperty("spa.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Spa.getBooleanProperty("spa.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Spa.isDesktopApplicationEnabled() ? "spadesktop.policy" : "spa.policy");
