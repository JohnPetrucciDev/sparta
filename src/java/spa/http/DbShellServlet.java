...
public final class DbShellServlet extends HttpServlet {
    ...
    private static final String header =
            "<!DOCTYPE html>\n" +
                    ...
                    "<head>\n" +
                    "    <meta charset=\"UTF-8\"/>\n" +
                    "    <title>Spa H2 Database Shell</title>\n" +
    ...
    private static final String errorNoPasswordIsConfigured =
            "This page is password-protected, but no password is configured in spa.properties. " +
                    "Please set spa.adminPassword or disable the password protection with spa.disableAdminPassword";
