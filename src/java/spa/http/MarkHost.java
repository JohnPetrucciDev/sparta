...
import static spa.http.JSONResponses.INCORRECT_DATE;
import static spa.http.JSONResponses.INCORRECT_HOST;
import static spa.http.JSONResponses.INCORRECT_WEIGHT;
import static spa.http.JSONResponses.MISSING_DATE;
import static spa.http.JSONResponses.MISSING_HOST;
import static spa.http.JSONResponses.MISSING_WEIGHT;
...
public final class MarkHost extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        try {
            ...
            if (weight <= 0 || weight > Constants.MAX_BALANCE_SPA) {
