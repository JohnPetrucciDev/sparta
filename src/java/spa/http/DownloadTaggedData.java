...
import static spa.http.JSONResponses.PRUNED_TRANSACTION;
...
public final class DownloadTaggedData extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest request, HttpServletResponse response) throws SpaException {
        ...
        if (taggedData == null && retrieve) {
            if (Spa.getBlockchainProcessor().restorePrunedTransaction(transactionId) == null) {
    ...
    @Override
    protected JSONStreamAware processRequest(HttpServletRequest request) throws SpaException {
