...
public final class GetGuaranteedBalance extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws SpaException {
        ...
        if (account == null) {
            response.put("guaranteedBalanceAPL", "0");
        } else {
            response.put("guaranteedBalanceAPL", String.valueOf(account.getGuaranteedBalanceAPL(numberOfConfirmations, Spa.getBlockchain().getHeight())));
        }
