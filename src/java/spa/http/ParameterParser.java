...
public final class ParameterParser {
    ...
    public static long getHoldingId(HttpServletRequest req, HoldingType holdingType) throws ParameterException {
        ...
        if (holdingType == HoldingType.APL && holdingId != 0) {
            throw new ParameterException(JSONResponses.incorrect("holding", "holding id should not be specified if holdingType is SPA"));
        }
        return holdingId;
    }
...
//    }
    ...
    public static Attachment.TaggedDataUpload getTaggedData(HttpServletRequest req) throws ParameterException, SpaException.NotValidException {
