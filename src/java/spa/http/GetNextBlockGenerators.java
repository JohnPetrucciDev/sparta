...
public final class GetNextBlockGenerators extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) {
        ...
        if (block == null) {
            curBlock = Spa.getBlockchain().getLastBlock();
        } else {
            try {
                curBlock = Spa.getBlockchain().getBlock(Convert.parseUnsignedLong(block));
                if (curBlock == null) {
        ...
        */
        ...
        Block curBlock = Spa.getBlockchain().getLastBlock();
        ...
        while (iterator.hasNext() && hubs.size() < limit) {
            ...
            hub.put("minFeePerByteAPL", hit.hub.getMinFeePerByteAPL());
