...
import spa.util.ReadWriteUpdateLock;
 ...
 *   CREATE ALIAS FTL_CREATE_INDEX FOR "spa.db.FullTextTrigger.createIndex"
 *       CALL FTL_CREATE(schema, table, columnList)
 *   CREATE ALIAS FTL_DROP_INDEX FOR "spa.db.FullTextTrigger.dropIndex"
 *       CALL FTL_DROP(schema, table)
 *   CREATE ALIAS FTL_SEARCH FOR "spa.db.FullTextTrigger.search"
 ...
 *   CREATE TRIGGER trigger_name AFTER INSERT,UPDATE,DELETE ON table_name FOR EACH ROW CALL "spa.db.FullTextTrigger"
 */
