...
package spa.env.service;

import spa.Spa;
import spa.env.LookAndFeel;

import javax.swing.*;

@SuppressWarnings("UnusedDeclaration")
public class SpaService_ServiceManagement {
    ...
    public static String[] serviceGetInfo() {
        return new String[]{
                "SPARTA Server", // Long name
                "Manages the SPA cryptographic currency protocol", // Description
                "true", // IsAutomatic
                "true", // IsAcceptStop
                "", // failure exe
                "", // args failure
    ...
    public static boolean serviceIsCreate() {
        return JOptionPane.showConfirmDialog(null, "Do you want to install the SPARTA service ?", "Create Service", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }
    ...
    public static boolean serviceIsDelete() {
        return JOptionPane.showConfirmDialog(null, "This SPARTA service is already installed. Do you want to delete it ?", "Delete Service", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }
