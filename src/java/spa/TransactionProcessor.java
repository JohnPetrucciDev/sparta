...
public interface TransactionProcessor extends Observable<List<? extends Transaction>,TransactionProcessor.Event> {
    ...
    void broadcast(Transaction transaction) throws SpaException.ValidationException;

    void processPeerTransactions(JSONObject request) throws SpaException.ValidationException;
    ...
    List<Transaction> restorePrunableData(JSONArray transactions) throws SpaException.NotValidException;
}
