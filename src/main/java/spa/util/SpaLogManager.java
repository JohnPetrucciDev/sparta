...
/**
 * Java LogManager extension for use with Spa
 */
public class SpaLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the Spa log manager
     *
     ...
     * done terminating the Spa processes.
     */
    public SpaLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during Spa shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Spa shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void spaShutdown() {
        super.reset();
