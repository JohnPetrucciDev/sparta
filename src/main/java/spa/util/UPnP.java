...
public class UPnP {
    ...
    private static void init() {
        ...
        try {
            ...
            GatewayDevice.setHttpReadTimeout(Spa.getIntProperty("spa.upnpGatewayTimeout", GatewayDevice.getHttpReadTimeout()));
            GatewayDiscover discover = new GatewayDiscover();
            discover.setTimeout(Spa.getIntProperty("spa.upnpDiscoverTimeout", discover.getTimeout()));
