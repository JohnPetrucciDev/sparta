...
import spa.SpaException.SpaIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws SpaIOException      Maximum count exceeded
     */
    private void incCount(long c) throws SpaIOException {
        count += c;
        if (count > limit)
            throw new SpaIOException("Maximum size exceeded: " + count);
    }
}
