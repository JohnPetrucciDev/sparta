    ...
    public static void main(String[] args) {
        try {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(unsigned));
                ...
                String senderSPA = Convert.spaAccount(Convert.fullHashToId(publicKeyHash));
                String secretPhrase;
                ...
                if (console == null) {
                    ...
                    secretPhrase = new String(console.readPassword("Secret phrase for account " + senderSPA + ": "));
                }
                Transaction.Builder builder = Spa.newTransactionBuilder(json);
