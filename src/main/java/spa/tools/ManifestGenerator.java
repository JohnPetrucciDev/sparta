...
import spa.Spa;
import spa.env.service.SpaService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/spa.manifest.mf", Spa.class.getCanonicalName(), "./lib");
        String serviceClassName = SpaService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/spaservice.manifest.mf", serviceClassName, "./lib");
    }
