...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws SpaException.NotValidException;

        Transaction build(String secretPhrase) throws SpaException.NotValidException;
    ...
    void validate() throws SpaException.ValidationException;
