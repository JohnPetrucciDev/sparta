...
import spa.http.EventListener.PendingEvent;
 ...
 * spa.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than spa.apiEventTimeout.</li>
 * </ul>
 *
