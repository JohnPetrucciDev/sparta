...
import static spa.http.JSONResponses.NOT_FORGING;
import static spa.http.JSONResponses.UNKNOWN_ACCOUNT;
...
public final class GetForging extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        int elapsedTime = Spa.getEpochTime() - Spa.getBlockchain().getLastBlock().getTimestamp();
