 ...
 * account ledger tracks all account changes as determined by the spa.ledgerAccounts,
 * spa.ledgerLogUnconfirmed and spa.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than spa.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the spa.maxAPIRecords property
 ...
 *     <tr>
 *       <td>SPA_BALANCE</td>
 *       <td>Change in the SPA balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_SPA_BALANCE</td>
 *       <td>Change in the unconfirmed SPA balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws SpaException        Invalid request
     */
    @Override
