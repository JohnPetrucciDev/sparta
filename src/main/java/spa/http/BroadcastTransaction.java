 ...
 * Clients first submit their transaction using {@link spa.http.CreateTransaction} without providing the secret phrase.<br>
 * In response the client receives the unsigned transaction JSON and transaction bytes.
 * <p>
 * The client then signs and submits the signed transaction using {@link spa.http.BroadcastTransaction}
 * <p>
 * The default wallet implements this procedure in nrs.server.js which you can use as reference.
 * <p>
 * {@link spa.http.BroadcastTransaction} accepts the following parameters:<br>
 ...
 * <p>
 * Prunable appendages are classes implementing the {@link spa.Appendix.Prunable} interface.
 */
