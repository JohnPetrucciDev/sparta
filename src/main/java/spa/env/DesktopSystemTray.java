...
public class DesktopSystemTray {
    ...
    void createAndShowGUI() {
        ...
        imageIcon = new ImageIcon("html/www/img/spa-icon-32x32.png", "tray icon");
        ...
        if (!Spa.isDesktopApplicationEnabled()) {
    ...
    private void displayStatus() {
        ...
        for (Generator generator : allGenerators) {
            generators.append(Convert.spaAccount(generator.getAccountId())).append(' ');
        }
        ...
        addDataRow(statusPanel, "Application", Spa.APPLICATION);
        addDataRow(statusPanel, "Version", Spa.VERSION);
        ...
        addDataRow(statusPanel, "User folder", String.valueOf(Paths.get(Spa.getUserHomeDir()).toAbsolutePath()));
        ...
        if (lastBlock != null) {
            ...
            addDataRow(statusPanel, "Seconds passed", String.valueOf(Spa.getEpochTime() - lastBlock.getTimestamp()));
        ...
        addDataRow(statusPanel, "Process id", Spa.getProcessId());
        addEmptyRow(statusPanel);
        ...
        if (statusDialog == null || !statusDialog.isVisible()) {
            ...
            statusDialog = pane.createDialog(wrapper, "SPARTA Server Status");
