...
public abstract class SpaException extends Exception {
    ...
    protected SpaException() {
        super();
    }

    protected SpaException(String message) {
        super(message);
    }

    protected SpaException(String message, Throwable cause) {
        super(message, cause);
    }

    protected SpaException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends SpaException {
    ...
    public static final class SpaIOException extends IOException {

        public SpaIOException(String message) {
            super(message);
        }

        public SpaIOException(String message, Throwable cause) {
            super(message, cause);
        }
